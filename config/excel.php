...
return array(
    ...
    'properties' => array(
        'creator'        => 'QSoft Vietnam',
        'lastModifiedBy' => 'QSoft Vietnam',
        'title'          => 'Spreadsheet',
        'description'    => 'Default spreadsheet export',
        'subject'        => 'Spreadsheet export',
        'keywords'       => 'qsoft vietnam, excel, export',
        'category'       => 'Excel',
        'manager'        => 'QSoft Vietnam',
        'company'        => 'QSoft Vietnam',
    ),
    ...
    */
    ...
    'creator'    => 'QSoft Vietnam Corporation',
